...
export const facts = [
  ...
  { value: "5", unit: "أنشطة", label: "تجاري · إداري · طبي · فندقي · ترفيهي" },
...
export const units: Unit[] = [
  ...
  },
  {
    ...
    pitch:
      "بجانب مستشفى كليوباترا مباشرة، بممرات واسعة ومصاعد مخصصة للمرضى وقرب مباشر من قطاع الصيدليات.",
...
export const location = {
  ...
  points: [
    ...
    { title: "بجانب مستشفى كليوباترا", note: "تدفق طبي مستمر على مدار الساعة" },
...
export const faqs = [
  {
    ...
    a: "يقع المشروع على المحور المركزي بمدينة السادس من أكتوبر، على بُعد 20 متراً من ميدان النجدة بالحي الأول، بجانب مستشفى كليوباترا وبجوار بنك التعمير والإسكان.",
  },
  {
